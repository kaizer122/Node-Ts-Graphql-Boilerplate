              ...
              <tr>
                ...
                <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%; padding: 20px;">
                    <tr>
                      ...
                      ${body}
                      <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-top:40px; color: black;">
...
export const getParagraphStyle = () =>
  'style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; color: black"';
